...
import { ANCHORS, PHONE } from "@/lib/links";
    ...
    <section id="about" className="bg-white py-20 px-6">
      <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-12 lg:gap-14 items-center">
        ...
        <div className="lg:w-[55%] w-full">
          <h2 className="font-heading font-light text-gold text-[32px] lg:text-[40px] leading-tight mb-5">
            Welcome to My Cosmetic Tattoo Studio
          </h2>

          <p className="text-ink text-[16px] leading-[1.7] mb-4">
          ...
          <p className="text-ink text-[16px] leading-[1.7] mb-6">
          ...
          <div className="flex gap-4 items-start mb-5">
            <div className="flex-shrink-0 w-11 h-11 rounded-full bg-cream flex items-center justify-center text-gold text-[22px]">
              <CertifiedIcon />
            </div>
            <div>
              <h3 className="font-heading text-[15px] font-medium text-ink uppercase tracking-wide mb-1">
                Certified Artist
              </h3>
          ...
          <p className="text-[14px] italic text-[#777] mt-4 mb-5">
            Call {PHONE} to arrange your consultation.
          </p>

          <Link
            href={ANCHORS.contact}
            className="inline-block bg-cream border border-ink rounded-[15px] px-10 py-3.5 font-josefin text-[18px] text-ink hover:bg-gold hover:text-white hover:border-gold transition-colors"
          >
            Get In Touch
          </Link>
        </div>
